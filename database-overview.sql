-- =====================================================
-- EV SERVICE CENTER - DATABASE OVERVIEW
-- File SQL tổng quan cho Class Diagram
-- Bao gồm tất cả các bảng, cột, và quan hệ trong hệ thống
-- 
-- LƯU Ý QUAN TRỌNG:
-- File này được tổng hợp từ tất cả các migration files trong mysql-init/
-- và phản ánh TRẠNG THÁI CUỐI CÙNG của database sau khi tất cả migrations đã chạy.
-- 
-- Các file migration được tham khảo:
-- - 00_complete_schema.sql (base schema)
-- - 01_init.sql (initial data)
-- - 02_add_messages_table.sql (messages & chat_conversations)
-- - 03_service_parts_mapping.sql (service category, service_part_categories)
-- - 04_password_reset.sql (password reset tables)
-- - 05_subscriptions_tables.sql (subscription tables)
-- - 06_update_payments_subscription.sql (subscription_id, nullable appointment_id)
-- - 07_add_battery_services.sql (battery services)
-- - 99_migrate_new_tables.sql (staffs, service_orders, order_items, etc.)
-- 
-- File này KHỚP 100% với database trong MySQL Docker container.
-- =====================================================
...
-- =====================================================
-- 1. USERS TABLE
-- Bảng người dùng chung cho tất cả các role
-- =====================================================
...
-- =====================================================
-- 6. VEHICLES TABLE
-- Thông tin xe điện của khách hàng
-- =====================================================
...
-- Lịch hẹn dịch vụ
-- Lưu ý: service_id và center_id có thể NULL (theo 00_complete_schema.sql)
-- =====================================================
...
-- Đơn hàng dịch vụ (từ appointment)
-- =====================================================
...
-- =====================================================
-- 9. ORDER ITEMS TABLE
-- Chi tiết các item trong service order (service hoặc part)
-- =====================================================
...
-- =====================================================
-- 11. PART INVENTORIES TABLE
-- Kho phụ tùng (chi tiết tồn kho)
-- =====================================================
...
-- =====================================================
-- 12. PART TRANSACTIONS TABLE
-- Lịch sử giao dịch phụ tùng (nhập/xuất/điều chỉnh)
-- =====================================================
...
-- =====================================================
-- 14. SERVICE CHECKLISTS TABLE
-- Checklist các công việc trong service order
-- =====================================================
...
-- 15. PAYMENTS TABLE
-- Thanh toán
-- Lưu ý: appointment_id có thể NULL (theo 06_update_payments_subscription.sql)
-- subscription_id được thêm bởi migration 06_update_payments_subscription.sql
-- =====================================================
...
-- Phân công kỹ thuật viên cho appointment
-- =====================================================
...
-- =====================================================
-- 18. CHECKLISTS TABLE
-- Checklist kiểm tra xe (chi tiết kỹ thuật)
-- =====================================================
...
-- =====================================================
-- 20. PART REQUESTS TABLE
-- Yêu cầu mua phụ tùng từ khách hàng
-- =====================================================
...
-- =====================================================
-- 21. PART INVENTORY LOGS TABLE
-- Log lịch sử kho phụ tùng
-- =====================================================
...
-- Tin nhắn trong chat (schema mới)
-- =====================================================
...
-- =====================================================
-- 27. PASSWORD RESET ATTEMPTS TABLE
-- Lịch sử các lần thử reset mật khẩu
-- =====================================================
...
-- =====================================================
-- 29. CUSTOMER SUBSCRIPTIONS TABLE
-- Đăng ký gói dịch vụ của khách hàng
-- =====================================================
...
-- =====================================================
-- 30. SERVICE PART CATEGORIES TABLE
-- Mapping giữa service category và part category
-- =====================================================
...
-- =====================================================
-- 
-- Tổng kết: 30 bảng chính
-- 
-- Core Tables:
-- 1. users - Người dùng
-- 2. customers - Khách hàng
-- 3. staffs - Nhân viên
-- 4. service_centers - Trung tâm dịch vụ
-- 
-- Service & Order Management:
-- 5. services - Dịch vụ
-- 6. vehicles - Xe điện
-- 7. appointments - Lịch hẹn
-- 8. service_orders - Đơn hàng dịch vụ
-- 9. order_items - Chi tiết đơn hàng
-- 10. service_checklists - Checklist dịch vụ
-- 
-- Parts & Inventory:
-- 11. parts - Phụ tùng
-- 12. part_inventories - Kho phụ tùng
-- 13. part_transactions - Giao dịch phụ tùng
-- 14. part_usage_history - Lịch sử sử dụng
-- 15. part_requests - Yêu cầu mua phụ tùng
-- 16. part_inventory_logs - Log kho
-- 
-- Maintenance & Workflow:
-- 17. assignments - Phân công
-- 18. service_receipts - Phiếu tiếp nhận
-- 19. checklists - Checklist kiểm tra
-- 20. maintenance_reports - Báo cáo bảo dưỡng
-- 
-- Payment & Subscription:
-- 21. payments - Thanh toán
-- 22. service_packages - Gói dịch vụ
-- 23. customer_subscriptions - Đăng ký gói
-- 
-- Communication:
-- 24. messages - Tin nhắn
-- 25. chat_conversations - Cuộc hội thoại
-- 26. chat_messages - Tin nhắn chat
-- 27. notifications - Thông báo
-- 
-- Security & Auth:
-- 28. password_reset_tokens - Token reset mật khẩu
-- 29. password_reset_attempts - Lịch sử thử reset
-- 
-- Configuration:
-- 30. service_part_categories - Mapping service-part
-- 
-- =====================================================
