...
/**
 * Controller để kiểm tra kết nối MariaDB database
 */
@RestController
...
public class DatabaseController {
    ...
    /**
     * GET /api/database/test - Kiểm tra kết nối MariaDB database
     */
    @GetMapping("/test")
    ...
    public ResponseEntity<?> getDatabaseInfo() {
        try (Connection connection = dataSource.getConnection()) {
            ...
            return ResponseEntity.badRequest().body("Unexpected error getting database info: " + e.getMessage());
        }
    }
    ...
    public static class DatabaseInfoResponse {
        ...
        public DatabaseInfoResponse(String databaseProductName, String databaseVersion,
                String driverName, String driverVersion, String catalog, boolean isMySQL, boolean isMariaDB,
                long timestamp) {
            this.databaseProductName = databaseProductName;
            this.databaseVersion = databaseVersion;
